...
const pages = [
  {
    ...
    paragraphs: [
      ...
      'Uma alimentação saudável e equilibrada é necessário para ter mais qualidade de vida, mas se conectar com suas raízes é primordial para entender sua história. Nossa experiência promove uma inserção na cultura local aliada a uma refeição nutritiva.',
    ]
  },
  {
    img: bg1,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Nesse aspecto incentivamos o retorno de nossos clientes com o programa “Cartão de Fidelidade”, bem como a proposta de marketing social através do “Pertenciguá”.',
    ]
  },
  {
    img: bg1,
    ...
    paragraphs: [
      ...
      'A proposta de marketing social do Aliment\'Art traz o “Pertenciguá” que é um programa de incentivo para os clientes residentes e/ou naturais do município de Paranaguá/PR, o qual concede desconto de 5% sobre o valor da consumação final no restaurante.',
    ]
  },
  {
    img: bg1,
    ...
    paragraphs: [
      ...
      'Como fator essencial no funcionamento do Aliment\'Art, são firmadas parcerias com artistas locais ligados ao caiçarismo, estabelecendo compromissos de participação em mostras e apresentações culturais.',
      'No âmbito gastronômico, buscamos fortalecer o relacionamento com os fornecedores dos insumos, principalmente, as proteínas utilizadas na composição de nossos pratos (vide cardápio).'
    ]
  },
  {
    img: bg1,
